...
class TestLinalg(TestCase):
    ...
    def test_eig_subnormal_input_no_overflow(self, device, dtype):
        ...
        # With the bug, the trailing eigenvector's imaginary part contained
        # garbage from past the end of the eigenvector buffer, and ASAN would
        # have already fired before reaching here. Verify A @ V = V @ diag(L)
        # to confirm the unpacker produced a structurally valid result.
